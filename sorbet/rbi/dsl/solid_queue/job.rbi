...
class SolidQueue::Job
  ...
  module CommonRelationMethods
    ...
    sig do
      params(
        ...
        order: Symbol,
        block: T.nilable(T.proc.params(object: ::SolidQueue::Job).void)
      ).returns(T.nilable(T::Enumerator[::SolidQueue::Job]))
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.nilable(T.proc.params(object: T::Array[::SolidQueue::Job]).void)
      ).returns(T.nilable(T::Enumerator[T::Enumerator[::SolidQueue::Job]]))
    end
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::SolidQueue::Job, Integer, String, T::Enumerable[T.any(::SolidQueue::Job, Integer, String, T::Enumerable[::SolidQueue::Job])])
