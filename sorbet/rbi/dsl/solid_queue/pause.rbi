...
class SolidQueue::Pause
  ...
  module CommonRelationMethods
    ...
    sig do
      params(
        ...
        order: Symbol,
        block: T.nilable(T.proc.params(object: ::SolidQueue::Pause).void)
      ).returns(T.nilable(T::Enumerator[::SolidQueue::Pause]))
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.nilable(T.proc.params(object: T::Array[::SolidQueue::Pause]).void)
      ).returns(T.nilable(T::Enumerator[T::Enumerator[::SolidQueue::Pause]]))
    end
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::SolidQueue::Pause, Integer, String, T::Enumerable[T.any(::SolidQueue::Pause, Integer, String, T::Enumerable[::SolidQueue::Pause])])
