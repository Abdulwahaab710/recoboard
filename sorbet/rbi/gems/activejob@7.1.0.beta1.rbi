...
module ActiveJob::Core
  ...
  #    end
  #
  # source://activejob//lib/active_job/core.rb#148
  ...
  # queuing adapter.
  #
  # source://activejob//lib/active_job/core.rb#106
  def serialize; end
  ...
  #
  # source://activejob//lib/active_job/core.rb#162
  ...
  # @return [Boolean]
  #
  # source://activejob//lib/active_job/core.rb#195
  def arguments_serialized?; end

  # source://activejob//lib/active_job/core.rb#191
  def deserialize_arguments(serialized_args); end

  # source://activejob//lib/active_job/core.rb#180
  def deserialize_arguments_if_needed; end

  # source://activejob//lib/active_job/core.rb#187
  def serialize_arguments(arguments); end

  # source://activejob//lib/active_job/core.rb#172
...
module ActiveJob::Exceptions
  ...
  #  end
  #
  # source://activejob//lib/active_job/exceptions.rb#145
  ...
  # source://activejob//lib/active_job/exceptions.rb#175
  def determine_jitter_for_delay(delay, jitter); end

  # source://activejob//lib/active_job/exceptions.rb#180
  def executions_for(exceptions); end

  # source://activejob//lib/active_job/exceptions.rb#189
...
module ActiveJob::Exceptions::ClassMethods
  ...
  #  end
  #
  # source://activejob//lib/active_job/exceptions.rb#118
  ...
  #  end
  #
  # source://activejob//lib/active_job/exceptions.rb#97
  ...
  #  end
  #
  # source://activejob//lib/active_job/exceptions.rb#59
...
class ActiveJob::LogSubscriber < ::ActiveSupport::LogSubscriber
  ...
  # source://activejob//lib/active_job/log_subscriber.rb#128
  ...
  # source://activejob//lib/active_job/log_subscriber.rb#103
  def enqueue_retry(event); end

  # source://activejob//lib/active_job/log_subscriber.rb#84
  def perform(event); end

  # source://activejob//lib/active_job/log_subscriber.rb#76
  def perform_start(event); end

  # source://activejob//lib/active_job/log_subscriber.rb#118
  def retry_stopped(event); end

  private

  # source://activejob//lib/active_job/log_subscriber.rb#143
  ...
  # source://activejob//lib/active_job/log_subscriber.rb#181
  def error(progname = T.unsafe(nil), &block); end

  # source://activejob//lib/active_job/log_subscriber.rb#197
  def extract_enqueue_source_location(locations); end

  # source://activejob//lib/active_job/log_subscriber.rb#152
  def format(arg); end

  # source://activejob//lib/active_job/log_subscriber.rb#173
  def info(progname = T.unsafe(nil), &block); end

  # source://activejob//lib/active_job/log_subscriber.rb#189
  def log_enqueue_source; end

  # source://activejob//lib/active_job/log_subscriber.rb#169
  def logger; end

  # source://activejob//lib/active_job/log_subscriber.rb#139
...
module ActiveJob::TestHelper
  ...
  #   end
  #
  # source://activejob//lib/active_job/test_helper.rb#399
  ...
  #   end
  #
  # source://activejob//lib/active_job/test_helper.rb#501
  ...
  #
  # source://activejob//lib/active_job/test_helper.rb#608
  ...
  #   end
  #
  # source://activejob//lib/active_job/test_helper.rb#646
  def queue_adapter; end
  ...
  # source://activejob//lib/active_job/test_helper.rb#689
  def filter_as_proc(filter); end

  # source://activejob//lib/active_job/test_helper.rb#703
  def flush_enqueued_jobs(only: T.unsafe(nil), except: T.unsafe(nil), queue: T.unsafe(nil), at: T.unsafe(nil)); end

  # source://activejob//lib/active_job/test_helper.rb#731
  ...
  # source://activejob//lib/active_job/test_helper.rb#738
