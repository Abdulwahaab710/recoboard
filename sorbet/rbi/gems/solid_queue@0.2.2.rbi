...
module ActiveJob
  class << self
    # source://activejob/7.2.1/lib/active_job/queue_adapter.rb#7
    def adapter_name(adapter); end

    # source://activejob/7.2.1/lib/active_job/deprecator.rb#4
    def deprecator; end

    # source://activejob/7.2.1/lib/active_job/gem_version.rb#5
    def gem_version; end

    # source://activejob/7.2.1/lib/active_job/enqueuing.rb#14
    def perform_all_later(*jobs); end

    # source://activejob/7.2.1/lib/active_job.rb#52
    def use_big_decimal_serializer; end

    # source://activejob/7.2.1/lib/active_job.rb#58
    def use_big_decimal_serializer=(value); end

    # source://activejob/7.2.1/lib/active_job.rb#69
    def verbose_enqueue_logs; end

    # source://activejob/7.2.1/lib/active_job.rb#69
    def verbose_enqueue_logs=(_arg0); end

    # source://activejob/7.2.1/lib/active_job/version.rb#7
    def version; end

    private

    # source://activejob/7.2.1/lib/active_job/instrumentation.rb#6
...
class ActiveJob::Base
  ...
  # source://activejob/7.2.1/lib/active_job/exceptions.rb#12
  ...
  # source://activejob/7.2.1/lib/active_job/logging.rb#15
  def logger; end

  # source://activejob/7.2.1/lib/active_job/logging.rb#15
  def logger=(val); end

  # source://activejob/7.2.1/lib/active_job/queue_adapter.rb#27
  def queue_adapter(&_arg0); end

  # source://activejob/7.2.1/lib/active_job/queue_name.rb#57
  ...
  class << self
    ...
    # source://activejob/7.2.1/lib/active_job/queue_adapter.rb#25
    def _queue_adapter; end

    # source://activejob/7.2.1/lib/active_job/queue_adapter.rb#25
    def _queue_adapter=(value); end

    # source://activejob/7.2.1/lib/active_job/queue_adapter.rb#24
    def _queue_adapter_name; end

    # source://activejob/7.2.1/lib/active_job/queue_adapter.rb#24
    def _queue_adapter_name=(value); end

    # source://activejob/7.2.1/lib/active_job/test_helper.rb#19
    ...
    # source://activejob/7.2.1/lib/active_job/enqueuing.rb#54
    ...
    # source://activejob/7.2.1/lib/active_job/queue_priority.rb#49
    def priority; end
    ...
    # source://activejob/7.2.1/lib/active_job/queue_name.rb#56
    ...
    # source://activejob/7.2.1/lib/active_job/exceptions.rb#11
...
module ActiveJob::QueueAdapters
  class << self
    # source://activejob/7.2.1/lib/active_job/queue_adapters.rb#138
    def lookup(name); end
  end
end
...
class SolidQueue::Configuration
  ...
  # source://solid_queue//lib/solid_queue/configuration.rb#77
  def load_config_from(file_or_hash); end

  # source://solid_queue//lib/solid_queue/configuration.rb#96
  ...
  # source://solid_queue//lib/solid_queue/configuration.rb#102
...
module SolidQueue::Process::GeneratedAssociationMethods
  ...
  # source://activerecord/7.2.1/lib/active_record/associations/builder/collection_association.rb#62
  def claimed_execution_ids; end

  # source://activerecord/7.2.1/lib/active_record/associations/builder/collection_association.rb#72
...
module SolidQueue::Processes::Runnable
  ...
  # source://solid_queue//lib/solid_queue/processes/runnable.rb#18
  def stop; end
  ...
  # @return [Boolean]
  #
  # source://solid_queue//lib/solid_queue/processes/runnable.rb#71
  ...
  #
  # source://solid_queue//lib/solid_queue/processes/runnable.rb#59
  def run; end

  # @return [Boolean]
  #
  # source://solid_queue//lib/solid_queue/processes/runnable.rb#75
  def running_inline?; end

  # @return [Boolean]
  #
  # source://solid_queue//lib/solid_queue/processes/runnable.rb#55
