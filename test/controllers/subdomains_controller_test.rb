...
class SubdomainsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subdomain" do
    assert_difference("Subdomain.count") do
      post subdomains_url, params: { subdomain: { domain_id: @subdomain.domain_id, name: @subdomain.name } }
    end
  ...
  test "should update subdomain" do
    patch subdomain_url(@subdomain), params: { subdomain: { domain_id: @subdomain.domain_id, name: @subdomain.name } }
